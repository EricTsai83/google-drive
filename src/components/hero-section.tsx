...
import { HeroHeader } from "@/components/_hero5-header";
            ...
            <div className="mx-auto md:-mt-20 lg:-mt-40">
              ...
              >
                <div className="-rotate-30 aspect-3/2 relative mx-auto lg:w-2/3">
                  <div className="bg-linear-to-b absolute inset-0 from-background via-transparent to-background"></div>
                  <div className="bg-linear-to-l absolute inset-0 from-background via-transparent to-background"></div>
                  <Image
